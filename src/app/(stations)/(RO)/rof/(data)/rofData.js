const ROFbaseColumns = [
  [
    ...
    { key: "Ja", value: [2], editable: false, info: "Number of elements in pressure vessel Ja,about 1 ~ 9" },
    { key: "Jb", value: [2], editable: false, info: "Number of elements in pressure vessel Jb,about 1 ~ 9)" },
    { key: "Jc", value: [2], editable: false, info: "Number of elements in pressure vessel Jc,about 1 ~ 9" },
    { key: "Jd", value: [2], editable: false, info: "Number of elements in pressure vessel Jd,about 1 ~ 9" },
  ],
  [
  ...
  [
    { key: "Pf", value: [0.0, 0.0, 0.0, 0], editable: false, info: "Feed water pressure to each stage Pf [bar]" },
    { key: "Pp", value: [0.0, 0.0, 0.0, 0], editable: false, info: "Permeate water pressure from each stage Pp [bar],normally Pp = 0" },
    { key: "PV", value: [0.0, 0.0, 0.0, 0], editable: false, info: "pressure vessels in each stage PV" },
    { key: "FF", value: [0.94, 0.94, 0.94, 0], editable: false, info: "Fouling factor in each stage FF,about 1 ~ 0.5 " },
    { key: "A", value: [40900, 40900, 37200, 0], editable: false, info: "Element active area in each stage A [m²]" },
    { key: "w", value: [1.018, 1.018, 5.874, 0], editable: false, info: "Water permeability in each stage w [l/m².h.bar]" },
    { key: "x", value: [0.074, 0.074, 0.339, 0], editable: false, info: "Salt permeability in each stage x [g/m².h.(g/l)]" },
  ],
  [
  ...
  [
    ...
    { key: "b", value: [0.00], editable: false, info: "Interstage pressure ratio b,≈ 0.99  without booster pump,about 1.1 ~ 1.5 with booster pump" },
    { key: "-", value: [0.00], editable: false, info: "" ,locked: true},
  ]
];
