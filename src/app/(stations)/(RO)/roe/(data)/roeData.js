const ROEbaseColumns = [
  ...
  [
    ...
    { key: "A", value: [40900, 40900, 37200], editable: false, info: "Membrane active area A [m²]" },
    { key: "w", value: [1.018, 1.018, 5.874], editable: false, info: "Water permeability w [L/m²·h·bar]" },
    { key: "x", value: [0.074, 0.074, 0.339], editable: false, info: "Salt permeability x" },
    { key: "-", value: [0, 0, 0], editable: false, info: "" },
  ],
  [
    { key: "Pfa", value: [74.755], editable: false, info: "Feed pressure at stage A Pf,a [bar]" },
    { key: "Pfb", value: [1000], editable: false, info: "Feed pressure at stage B Pf,b [bar]" },
    { key: "b", value: [1.4], editable: false, info: "Booster pressure ratio b" },
    { key: "PVa", value: [116.719], editable: false, info: "Pressure vessels in stage A" },
    { key: "PVb", value: [60.0], editable: false, info: "Pressure vessels in stage B" },
    { key: "PVc", value: [51.08], editable: false, info: "Pressure vessels in stage C" },
  ],
  [
