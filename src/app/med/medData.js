// نسخة أساسية واحدة لكل صفوف (editable false افتراضياً)
const baseRows = [
  [
    { key: "MED Design", value: "", editable: false, info: "NUll" },
    { key: "Ja", value: "1", editable: false, info: "Number of effects Ja" },
...
export const StationValueData = {
  Design: makeEditableByType(baseRows, "Design"),
  Demand: makeEditableByType(baseRows, "Demand"),
  Energy: makeEditableByType(baseRows, "Energy"),
  Rating: makeEditableByType(baseRows, "Rating"),
};
